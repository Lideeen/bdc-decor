<?php
    ...
    if(isset($_POST['image'])) {
        $image = $_POST['image'];
        $sql = "select description, position, image from falsh_balki_collection where id='$image'";
    ...
    if(isset($_POST['id'])){
        ...
        if(move_uploaded_file($_FILES['userfile']['tmp_name'], $target_file)) {
            ...
            if($result){
                ...
                $sql = "update falsh_balki_collection set image='$image_collection' where id='$id'";
                $result = $conn->query($sql);
            }
        }
    }
