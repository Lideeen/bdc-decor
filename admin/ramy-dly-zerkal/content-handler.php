    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        switch($type){
            case 1:
                $title = $_POST['title'];
                $text = $_POST['text'];
                $sql = "update content set title='$title', text='$text' where category=4 and type='$type'";
            ...
            case 2:
                $text = $_POST['text'];
                $sql = "update content set text='$text' where category=4 and type='$type'";
                $result = $conn->query($sql);
                if($result){
                    $messageCollection = "<b style='color:green'>Успешно сохранено</b><br /><a href='content.php'>Вернуться назад</a>";
                }
            ...
            case 7:
                ...
                $text = $_POST['text'];
                $sql = "update reference set link='$link', text='$text' where category=4 and type='$type'";
                $result = $conn->query($sql);
                if($result){
                    $messageCollection = "<b style='color:green'>Успешно сохранено</b><br /><a href='content.php'>Вернуться назад</a>";
                }
