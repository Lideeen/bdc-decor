<?php
    ...
    $item = $_GET['item'];
    $sql = "select id, full_name, name, height, width, length, price, installation_price, position, dop_info_1, dop_info_2, dop_info_3,
            images_dir, id_collection from plintus_potolochny where id='$item'";
